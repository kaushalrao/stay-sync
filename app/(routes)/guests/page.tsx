...
export default function GuestsPage() {
    return (
        <ClientAuthGuard>
            <div className="animate-fade-in mx-auto w-full px-0 md:px-6 pt-4 md:pt-8 pb-0 md:pb-8 safe-area-top flex flex-col h-full">
                ...
                <div className="bg-white/80 dark:bg-slate-900/40 backdrop-blur-xl md:border border-t border-b border-slate-300 dark:border-white/5 md:rounded-3xl p-0 md:p-6 shadow-xl flex-1 flex flex-col overflow-hidden">
                    <GuestsPageClient />
                </div>
            </div>
        </ClientAuthGuard>
