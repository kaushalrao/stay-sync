                ...
                <div className="flex flex-wrap gap-2">
                    {vars.map(tag => (
                        <button
                            ...
                            className="text-[10px] bg-slate-200 dark:bg-slate-800 text-slate-700 dark:text-slate-300 px-2.5 py-1.5 rounded-lg cursor-pointer hover:bg-orange-500 hover:text-white dark:hover:bg-orange-600 dark:hover:text-white border border-slate-300 dark:border-white/5 transition-all active:scale-95 flex items-center gap-1 font-medium"
                        >
