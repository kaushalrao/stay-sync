            ...
            {templates.map((t) => {
                ...
                return (
                    <button
                        ...
                        className={`group relative p-2 md:p-3 rounded-xl md:rounded-2xl flex flex-col items-center justify-center gap-1.5 transition-all duration-200 h-20 md:h-24 border hover:scale-[1.02] active:scale-95 ${isSelected
                    ...
                    >
                        <div className={`p-1.5 md:p-2.5 rounded-lg md:rounded-xl transition-all duration-200 ${isSelected
