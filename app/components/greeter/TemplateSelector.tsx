...
export const TemplateSelector: React.FC<{
    ...
    <div>
        ...
        <div className="flex md:grid md:grid-cols-4 gap-2 md:gap-3 overflow-x-auto md:overflow-visible pb-2 md:pb-0 scrollbar-hide snap-x">
            {templates.map((t) => {
                ...
                return (
                    <button
                        ...
                        className={`group relative flex-shrink-0 md:flex-shrink p-2 md:p-3 rounded-xl md:rounded-2xl flex flex-col items-center justify-center gap-1 md:gap-1.5 transition-all duration-200 w-24 md:w-full h-18 md:h-24 border hover:scale-[1.02] active:scale-95 snap-start ${isSelected
                    ...
                    >
                        <div className={`p-1 md:p-2.5 rounded-lg md:rounded-xl transition-all duration-200 ${isSelected
                        ...
                        <span className={`text-[8px] md:text-[10px] font-bold tracking-wide transition-colors truncate w-full text-center ${isSelected
                        ...
                        {isSelected && (
                            <div className="absolute top-1 right-1 w-1.5 h-1.5 rounded-full bg-green-400 shadow-[0_0_6px_rgba(74,222,128,0.6)]"></div>
                        )}
                    </button>
                )
            })}
