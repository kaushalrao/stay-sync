...
export const RevenueChart: React.FC<RevenueChartProps> = ({ data, year, loading }) => {
    if (loading) {
        return (
            <div className="bg-slate-900/40 backdrop-blur-xl border border-white/5 rounded-[1.5rem] md:rounded-[2.5rem] p-4 md:p-8 shadow-xl h-[420px] animate-pulse">
                <div className="h-8 w-48 bg-slate-800 rounded-lg mb-2"></div>
                <div className="h-4 w-32 bg-slate-800/50 rounded-lg mb-8"></div>
                <div className="h-[300px] w-full bg-slate-800/30 rounded-xl"></div>
            </div>
        );
    }

    return (
        <div className="bg-slate-900/40 backdrop-blur-xl border border-white/5 rounded-[1.5rem] md:rounded-[2.5rem] p-4 md:p-8 shadow-xl relative overflow-hidden group">
            ...
            <div className="relative z-10">
                <div className="flex justify-between items-end mb-8">
                    <div>
                        <h3 className="text-2xl font-black text-white tracking-tight mb-1">Revenue Analytics</h3>
                        <p className="text-sm text-slate-400 font-medium">Monthly performance for {year}</p>
                    </div>
