...
export const BookingNotificationEmail = ({
    ...
    const previewText = `${isNew ? 'New Booking' : 'Booking Cancelled'}: ${guestName} at ${propName}`;

    // Theme colors
    const theme = {
        main: isNew ? '#10B981' : '#F43F5E', // emerald-500 : rose-500
        bg: isNew ? '#ecfdf5' : '#fff1f2',     // emerald-50 : rose-50
        border: isNew ? '#d1fae5' : '#ffe4e6', // emerald-100 : rose-100
        text: isNew ? '#065f46' : '#9f1239',   // emerald-800 : rose-800
        darkText: isNew ? '#064e3b' : '#881337', // emerald-900 : rose-900
    };
                                ...
                                <Row className="mb-6">
                                    <Column className="w-[48px] align-middle">
                                        <div className="w-10 h-10 rounded-full bg-gray-50 border border-solid border-gray-100 flex items-center justify-center">
                                            <div className="text-lg text-center leading-10">{isNew ? '🎉' : '❌'}</div>
                                        </div>
                                    </Column>
